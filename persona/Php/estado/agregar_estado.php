...
<table width="696" height="25" border="0" cellpadding="0" cellspacing="0">
  <tr>
   <td width="684" height="37"><h1>Agregando Estado</h1></td>
...
<table  width="686" border="0" cellpadding="1" cellspacing="1">
 <tr>
<td width="337" align="right"><input name="nuevo" type="button" id="nuevo" value="  Nuevo" class='btn_act btn_nuevo_act_img'  title="Pulse para activar campos" /></td>
