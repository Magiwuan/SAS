...
<body> 
<form action="javascript: fn_agregar();" method="POST" id="form_titular" name="form_titular">
...
<select name="discapacidad[]" multiple="multiple"  id="discapacidad" title="Seleccionar">
  ...
  <table  width="686" border="0">
      <tr>
      <td width="235">&nbsp;onclick="limpiar_form(this.form)"</td>
      <td width="90"><input name="nuevo" type="button" id="nuevo" value="  Nuevo" class='btn_act btn_nuevo_act_img' title="Pulse para activar campos" /></td>
      <td width="97"><input name="agregar" type="submit"  class='btn_guardar_desact btn_guardar_act_img' disabled="disabled" id="agregar"  value=" Agregar" /></td>
      <td width="294">onClick="if(!valida()){return false};"</td>
      </tr>
  </table> 
</form>
</body>
