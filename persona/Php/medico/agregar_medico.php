...
<body> 
	...
	<form action="" method="post" id="form_medico" name="form_medico">
    	...
    	<tr>
     		<td width="687"><h1>Agregando M&eacute;dico</h1></td>
	  ...
	  <fieldset>
		...
		<tr>
          ...
          <td width="135"><div id="test" title="Ejemplo: 20643089, Si la C.I es menor a ocho (8) dígitos complete con ceros (0) a la izquierda Ejemplo: 08042667" class="test" style=" cursor: pointer; width:30px;">
