...
<tr>
   <td align="right"><input name="nuevo" type="button" id="nuevo" value="  Nuevo" class='btn_act btn_nuevo_act_img' onclick="limpiar_form(this.form)" title="Pulsar para activar el campo"/></td>
...
<hr />
<div id="div_listar_patologia"><div style="margin-left:300px;"><img src="../../Imagen_sistema/loading.gif"/></div></div>                   
</form>    
</div>
    </body>
</html>