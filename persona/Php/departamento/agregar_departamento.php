...
<fieldset>  
<legend></legend>
 <table width="677" height="33" cellpadding="0" cellspacing="0">
 <tbody>
  <tr>
    <td width="13" height="31">&nbsp;</td>
    <td width="171" height="31"><input name="ope" type="hidden" id="ope" value="I" hidden="hidden" /></td>
    <td width="60">Nombre:</td>
    <td width="431" ><input name="nombre" type="text" disabled="disabled" id="nombre" size="50" title="Nombre del Departamento" /></td>
  </tr>  
</tbody>
</table>   
</fieldset>    
...
<tr>
   <td width="330" height="26" align="right"><input name="nuevo" type="button" id="nuevo" value="  Nuevo" class='btn_act btn_nuevo_act_img' onclick="limpiar_form(this.form)" title="Pulse para activar el campo" /></td>
      <td width="346"><input name="agregar" type="submit"  class='btn_guardar_desact btn_guardar_act_img' disabled="disabled" id="agregar" onClick="if(!valida()){return false};" value=" Agregar" title="Guardar" /></td>
</tr>
</table>
<hr/>
<div id="div_listar_departamento"><div style="margin-left:300px;"><img src="../../Imagen_sistema/loading.gif"/></div>
</div>    
</form>    
</div>
</body>
