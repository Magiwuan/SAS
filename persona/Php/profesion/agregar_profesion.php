...
<head>
    ...
    <script language="javascript" type="text/javascript" src="../../JavaScript/profesion_jquery.js"></script>
    <script language="javascript" type="text/javascript" src="../../JavaScript/profesion.js"></script>   
...
<body>
<div id="cuerpo">     
<form action="" method="post" id="form_profesion" name="form_profesion">
 <table width="686" height="25" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="664"> <h1> Agregando Profesión </h1></td>
...
<tbody>
  <tr>
   ...
   <td width="166" height="30"><input name="ope" type="hidden" id="ope" value="I" hidden="hidden" /></td>
   <td width="65">Nombre:</td>
   <td width="431" ><input name="nombre" type="text" disabled="disabled" id="nombre" size="50" title="Nombre de la Profesión" /></td>
  </tr>       
</tbody>
</table>   
</fieldset>     
...
<tr>
   <td width="329" height="26" align="right"><input name="nuevo" type="button" id="nuevo" value="  Nuevo" class='btn_act btn_nuevo_act_img' onclick="limpiar_form(this.form)" title="Pulse para activar campo" /></td>
      <td width="347"><input name="agregar" type="submit"  class='btn_guardar_desact btn_guardar_act_img' disabled="disabled" id="agregar" onClick="if(!valida()){return false};" value=" Agregar" title="Guardar" /></td>
</tr>
</table>
<hr />
<div id="div_listar_profesion"><div style="margin-left:300px;"><img src="../../Imagen_sistema/loading.gif"/></div>
</div>   
</form>    
</div>    
</body>
