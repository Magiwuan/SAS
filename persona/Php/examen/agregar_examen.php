...
<form action="" method="post" id="form_examen" name="form_examen">
  ...
  <tr>
  <td width="686" height="37"><h1>Agregando Exámen</h1></td>
   <td width="22" valign="top"><input name="cancelar" type="button" id="cancelar" class='btn_cancelar_act_img' onclick="location.href='../../../html/blanco.html'" /></td
  ></tr>
  </table>
  <fieldset>  
  <legend></legend>
  <table width="681" height="81" class="formulario" cellpadding="0" cellspacing="0">
  <tbody>
  <tr>
