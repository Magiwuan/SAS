...
<form action=""   method="post" id="form_especialidad" name="form_especialidad">
 <table width="686" height="25" border="0" cellpadding="0" cellspacing="0">
  <tr>
  <td width="706"><h1>Agregando Especialidad</h1></td>
...
<fieldset>  
 <legend></legend>
  <table width="386" height="69" class="formulario">
  <tbody>
   <tr>
...
<hr />
 <div id="div_listar_especialidad"><div style="margin-left:300px;"><img src="../../Imagen_sistema/loading.gif"/></div></div>
</form>    
</div>
</body>
</html>