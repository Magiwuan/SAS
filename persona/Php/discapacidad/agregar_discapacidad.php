...
.btn_guardar_desact:hover{
 ...
 <body>
        <div id="cuerpo">
          <form action="" method="post" id="form_discapacidad" name="form_discapacidad">
            <table width="686" height="25" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="664"><h1> Agregando Discapacidad </h1></td>
              ...
              <fieldset>  
   				<legend></legend>
    			<table width="677" height="38" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
                          <td width="13" height="36">&nbsp;</td>
                          <td width="134" height="36"><input name="ope" type="hidden" id="ope" value="I" hidden="hidden" /></td>
                          <td width="56">Nombre:</td>
                          <td width="472" ><label for="textarea">
                              <input name="nombre" type="text" disabled="disabled" class="required" id="nombre" size="60"  title="Nombre de la Discapacidad"/>
                          </label>
                          </td>
                        </tr>
...
<table  width="686" border="0">
 <tr>
    <td width="334" align="right"><input name="nuevo" type="button" id="nuevo" value="  Nuevo" class='btn_act btn_nuevo_act_img' onclick="limpiar_form(this.form)"  title="Pulsar para activar campo"/></td>
      <td width="342"><input name="agregar" type="submit"  class='btn_guardar_desact btn_guardar_act_img' disabled="disabled" id="agregar" onClick="if(!valida()){return false};" value=" Agregar"  title="Guardar"/></td>
</tr>
</table>
<hr />
